...
E_energy_per_element = rowfun(@(Areaum2, EsquaredNormal) (1/epsilon)*.5*layer_thickness*Areaum2*(10^-12)*EsquaredNormal,Data, 'InputVariables', {'Areaum2' 'Esquared_Normal'}, 'OutputVariableName', 'Energy');
