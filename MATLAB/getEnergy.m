...
E_energy_per_element = rowfun(@(Areaum2, Esquared) epsilon*.5*layer_thickness*10^-9*Areaum2*(10^-12)*Esquared,Data, 'InputVariables', {'Areaum2' 'Esquared'}, 'OutputVariableName', 'Energyperm');
