...
E_energy_per_element = rowfun(@(Areaum2, Esquared) epsilon_zero*epsilon*.5*layer_thickness*Areaum2*(10^-12)*Esquared,Data, 'InputVariables', {'Areaum2' 'Esquared'}, 'OutputVariableName', 'Energyperm');
